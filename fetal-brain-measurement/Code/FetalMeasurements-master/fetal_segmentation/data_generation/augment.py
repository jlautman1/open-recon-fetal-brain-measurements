...
from fetal_segmentation.utils.image_manipulation import *
from fetal_segmentation.utils.read_write_data import *
...
def augment_data(data, truth, data_min, data_max, mask=None, scale_deviation=None, iso_scale_deviation=None,
                 ...
                 piecewise_affine=None, elastic_transform=None, intensity_multiplication_range=None, min_crop_size=None,
    ...
    ##################################
    #TODO: Add cropping augmentation here before image distortion
    ...
    if mask is None:
        ...
        if truth_range is None:
            ...
            mask_data = interpolate_affine_range(distorted_mask_data, distorted_mask_affine,
                                                 truth_range, order=1, mode='constant', cval=100)#TODO: Change cval to max value instead of hardcoded 100
